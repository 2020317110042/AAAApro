    ...
    public ExportFormatResultType exportProcess(final String name, final Integer processId, final String branch, final Version version,
        ...
        try {
            ...
            if (isRequestForNativeFormat(processId, branch, version, format)) {
                Native native_ = nativeRepo.getNative(processId, branch, version.toString(), format);
                String content_ = native_.getContent();
                ByteArrayDataSource byteArrayDataSource = new ByteArrayDataSource(content_, "text/xml");
                DataHandler dataHandler = new DataHandler(byteArrayDataSource);
                exportResult.setNative(dataHandler);
