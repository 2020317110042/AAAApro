 ...
 *
 */
public class AddNodePropagationFromG2CGCommand implements Command {
    ...
    public AddNodePropagationFromG2CGCommand(Graph originalMergedModel, Graph variantToBeChanged, String lable,
    ...
    public void execute(){
        PropagationG2CG.AddNodePropagation2CG(mergedModel, variantToBeChanged, v_p, v_s, new_v, lable, front_edge_id, rear_edge_id, vertexPairFromG2CGs, edgePairFromG2CGs);
    }
}
